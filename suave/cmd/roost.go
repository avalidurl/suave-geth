...
func main() {
	...
	txnResult, err := sdk.DeployContract(e2e.BatchAuctionContract.Code, mevmClt)
	if err != nil {
	...
	batchAuctionContract = sdk.GetContract(receipt.ContractAddress, e2e.BatchAuctionContract.Abi, mevmClt)
}
